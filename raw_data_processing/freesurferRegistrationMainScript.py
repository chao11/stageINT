...
for subj in subjectList:
    ...
    if  os.path.isdir(xfm) and len(os.listdir(xfm))==7:
        ...
        cmd = 'tkregister2 --mov %s/%s/mri/orig.mgz --targ %s/%s/mri/rawavg.mgz --regheader --reg junk --fslregout freesurfer2struct.mat --noedit; ' %(SUBJECTS_DIR,subj,SUBJECTS_DIR,subj)
        print cmd
