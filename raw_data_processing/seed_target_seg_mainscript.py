...
fsl5.0-fslmaths parc_freesurfer/parcellisation_freesurfer.nii -thr 1000 -uthr 1000 freesurfer_seg/sub6.nii.gz
fsl5.0-fslmaths parc_freesurfer/parcellisation_freesurfer.nii -thr 2000 -uthr 2000 freesurfer_seg/sub7.nii.gz
fsl5.0-fslmaths freesurfer_seg/sub1.nii.gz -add freesurfer_seg/sub2.nii.gz -add freesurfer_seg/sub3.nii.gz -add freesurfer_seg/sub4.nii.gz -add freesurfer_seg/sub5.nii.gz -add freesurfer_seg/sub6.nii.gz -add freesurfer_seg/sub7.nii.gz -add freesurfer_seg/lh_STS.nii.gz -add freesurfer_seg/lh_STG.nii.gz -add freesurfer_seg/rh_STG.nii.gz -add freesurfer_seg/rh_STS.nii.gz freesurfer_seg/sub_target.nii.gz
