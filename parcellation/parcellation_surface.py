...
if space == 'surface':  # if use the connmat of probtrack using surface
    ...
    seed_name = '{}_big_STS+STG.gii'.format(hemi)
...
matrix = op.join(tracto_dir, matrix_name)

output_gii_parcellation_path = op.join(tracto_dir, '{}_norma_{}_{}_parcellation_cl{}.gii'.format(output_name, hemi,
                                                                                                altas, nb_clusters))

print 'subject ID: {}\n surface parcellation for {}, altas = {}, number of clusters = {}'.format(subject, hemi, altas,
                                                                                                 nb_clusters)
