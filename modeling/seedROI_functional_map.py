...
coord_path = '/hpc/crise/hao.c/data/{}/tracto/{}_STS+STG_{}/coords_for_fdt_matrix2'.format(subject, hemisphere.upper(),altas)
...
y_mask_nii_path = '/hpc/crise/hao.c/data/{}/{}_{}_{}_mask.nii.gz'.format(subject, hemisphere, altas, contrast)
y_mask_gii_path = '/hpc/crise/hao.c/data/{}/{}_{}_{}_mask.gii'.format(subject, hemisphere, altas, contrast)
